...
public class PanelPanelModificarDatosNombreCientifico extends JPanel {
	 ...
	 * Create the panel.
	 */
	public PanelPanelModificarDatosNombreCientifico(Arbol arbol, Statement st, int id) {
		setLayout(null);
		...
		btnSi.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new Conexion().modificarLineaString(id, st, txtNombreCientifico.getText(), "nombre_cientifico");
			}
		});
